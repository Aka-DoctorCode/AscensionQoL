...
If you wish to turn off any of the modules type in chat: **`/aqol`** to access the menu.
...
Si deseas desactivar alguno de los módulos, escribe en el chat: **`/aqol`** para acceder al menú.
